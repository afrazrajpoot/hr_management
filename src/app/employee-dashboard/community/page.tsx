        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="card-primary border-2 border-primary/20 overflow-hidden relative">
            ...
            <CardHeader className="text-center pb-2 relative z-10">
              ...
              <CardTitle className="text-3xl font-bold">Genius Factor Academy Community</CardTitle>
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-card-foreground">Network with Experts</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-card-foreground">Exclusive Content</h3>
                      <p className="text-sm text-muted-foreground">Access premium workshops and resources.</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-card-foreground">Peer Support</h3>
                      <p className="text-sm text-muted-foreground">Get feedback and support from peers.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="mt-1 bg-green-500/10 p-1 rounded-full">
                    ...
                    <div>
                      <h3 className="font-semibold text-card-foreground">Career Opportunities</h3>
                      <p className="text-sm text-muted-foreground">First access to job postings and gigs.</p>
                    </div>
                  </div>
                </div>
              </div>
